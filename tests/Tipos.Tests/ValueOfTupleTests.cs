...
public class ValueOfTupleTests
{
    ...
    {
        var address = Address.From(("16 Food Street", "London", Postcode.From("N1 1LT")));
    ...
    {
        var address1 = Address.From(("16 Food Street", "London", Postcode.From("N1 1LT")));
        var address2 = Address.From(("16 Food Street", "London", Postcode.From("N1 1LT")));
        var address3 = Address.From(("17 Food Street", "London", Postcode.From("N1 1LT")));
